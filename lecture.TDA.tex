...
\title[Math Intro Data Anal]{An Introduction to Topological Data Analysis}
\author{Yuan Yao}
...
\frame{
 ...
 \item Graph $G$ may or may not reflect natural metric (e.g. similarity in genomics)
 \item Sometimes global embedding coordinates are not a good way to organize/visualize the data (e.g. $d>3$) 
 \item Sometimes all that is required is a qualitative view
 \end{itemize}
}
...
\frame{
\frametitle{So we need Topology here}
\begin{itemize}
...
\subsection{What Kind of Topological Methods?}
...
\frametitle{Topology}
\begin{itemize}
\item The see that these pairs are \emph{same} requires distortion of distances, i.e. stretching and shrinking
\item We do not permit \emph{tearing}, i.e. distorting distances in a discontinuous way
\item How to make this precise, especially in discrete and noisy setting?
\end{itemize}
}
...
\subitem \tiny Leonhard Euler 1736, Seven Bridges of Königsberg
...
\item \textcolor{blue}{Combinatorial} topology: mappings on simplicial (cell) complexes
...
\subitem simplicial complexes for data representation
\subitem filtration on simplicial complexes
\subitem persistent homology
\end{itemize}
}
...
\begin{figure}[!h]
%\centering
\includegraphics[width=0.8\textwidth]{./figures/betti_sphere.png}  
%\caption{The birth and death of connected components.}
\end{figure}
}
...
\frame{
\frametitle{Example: Nerve/\v{C}ech Complex}
\begin{figure}[!h]
\centering
...
% \begin{itemize}
% \item \textcolor{red}{Morse Theory} and pathway analysis of \textcolor{blue}{biomolecular folding} (e.g. RNA hairpin)
% \item combinatorial \textcolor{red}{Hodge Theory} and statistical \textcolor{blue}{rank aggregation}
% \end{itemize}
% where some classics in mathematics get ``married'' with modern massive data analysis.
% 
%\end{column}
%\begin{column}{0.2\textwidth}
%\begin{figure}[!h]
%%\centering
%\includegraphics[width=0.7\textwidth]{figures/cooccurrence_mat.pdf}  \\
%\includegraphics[width=0.7\textwidth]{figures/cooccurrence.pdf} 
%\end{figure}
%\end{column}
%\end{columns}
}
...
\end{figure}
\begin{itemize}
\item Toolbox: JPlex (\textcolor{blue}{\tt http://comptop.stanford.edu/})
...
\subsection{Image}
\frame{
\frametitle{Application II: Natural Image Statistics}
\begin{itemize}
